#############################################################################
# Makefile for building: caishen-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: sob. mar 29 20:03:06 2014
# Project:  caishen-qt-linux.pro
# Template: app
# Command: /usr/bin/qmake-qt4 USE_UPNP=1 USE_QRCODE=1 USE_IPV6=0 -o Makefile caishen-qt-linux.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=0 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode -lminiupnpc /home/oisis/work/CCoins/caishen/new/caishen/src/leveldb/libleveldb.a /home/oisis/work/CCoins/caishen/new/caishen/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		caishen-qt-linux.pro
QMAKE_TARGET  = caishen-qt
DESTDIR       = 
TARGET        = caishen-qt
...
$(TARGET): /home/oisis/work/CCoins/caishen/new/caishen/src/leveldb/libleveldb.a /home/oisis/work/CCoins/caishen/new/caishen/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_qrcodedialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: caishen-qt-linux.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=1 USE_QRCODE=1 USE_IPV6=0 -o Makefile caishen-qt-linux.pro
...
/home/oisis/work/CCoins/caishen/new/caishen/src/leveldb/libleveldb.a: FORCE
	cd /home/oisis/work/CCoins/caishen/new/caishen/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/oisis/work/CCoins/caishen/new/caishen/build/build.h: FORCE
	cd /home/oisis/work/CCoins/caishen/new/caishen; /bin/sh share/genbuild.sh /home/oisis/work/CCoins/caishen/new/caishen/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/images/caishen-256x256.png \
